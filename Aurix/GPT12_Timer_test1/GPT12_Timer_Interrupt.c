...
void initGpt12Timer(void)
{
    ...
    IfxGpt12_T3_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_10ms);                        /* Set T3 start value           */
    ...
    //IfxGpt12_T3_enableOutput(&MODULE_GPT120, 1);
}
...
unsigned int getTimer2(void)
{
  return  IfxGpt12_T2_getTimerValue(&MODULE_GPT120);
}
